 ...
 * Modified by Shani S; Licensed GPLv3 */
(function (root, factory) {
  ...
  (function () {
    ...
    Plugin.prototype.structure = function () {
      ...
      if (this.s.download) {
        this.$outer.find('.lg-toolbar').append('<a href="#" id="lg-download" aria-label="Download" target="_blank" download class="lg-download lg-icon"></a>');
      }
    ...
    Plugin.prototype.loadContent = function (index, rec, delay) {
      ...
      if (!_this.$slide.eq(index).hasClass('lg-loaded')) {
        if (iframe) {
          ...
          _this.$slide.eq(index).prepend('<div class="lg-video-cont ' + videoClass + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + _poster + '" alt="Poster"></div></div>');
          ...
          _alt = _alt ? 'alt="' + _alt + '"' : '';
            if(_alt==""){_alt='alt="Proconex Photo"'}
    ...
    Pager.prototype.init = function () {
      ...
      if (_this.core.s.dynamic) {
        for (var i = 0; i < _this.core.s.dynamicEl.length; i++) {
          pagerList += '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + _this.core.s.dynamicEl[i].thumb + '" alt="Proconex Photo"></div></span>';
        }
      } else {
        _this.core.$items.each(function () {

          if (!_this.core.s.exThumbImage) {
            pagerList += '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + $(this).find('img').attr('src') + '" alt="Proconex Photo"></div></span>';
          } else {
            pagerList += '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + $(this).attr(_this.core.s.exThumbImage) + '"  alt="Proconex Photo"></div></span>';
          }
  ...
  (function () {
    ...
    Thumbnail.prototype.build = function () {
      ...
      function getThumb(src, thumb, index) {
        ...
        thumbList += '<div data-vimeo-id="' + vimeoId + '" class="lg-thumb-item" style="width:' + _this.core.s.thumbWidth + 'px; height: ' + _this.core.s.thumbHeight + '; margin-right: ' + _this.core.s.thumbMargin + 'px"><img src="' + thumbImg + '"  alt="Proconex Photo"></div>';
        vimeoId = '';
      }
...
(function (root, factory) {
  ...
  (function () {
    ...
    Share.prototype.init = function () {
      ...
      var shareHtml = '<div class="lg-out-icon"><button type="button" class="lg-icon" id="lg-share" aria-label="Share"  aria-haspopup="true" aria-expanded="false"></button>'
        + '<ul class="lg-dropdown" style="position: absolute;">';
      shareHtml += _this.core.s.facebook ? '<li><a href="#" id="lg-share-facebook" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.facebookDropdownText + '</span></a></li>' : '';
      shareHtml += _this.core.s.twitter ? '<li><a href="#" id="lg-share-twitter" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.twitterDropdownText + '</span></a></li>' : '';
      shareHtml += _this.core.s.googlePlus ? '<li><a href="#" id="lg-share-googleplus" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.googlePlusDropdownText + '</span></a></li>' : '';
      shareHtml += _this.core.s.pinterest ? '<li><a href="#" id="lg-share-pinterest" target="_blank"><span class="lg-icon"></span><span class="lg-dropdown-text">' + this.core.s.pinterestDropdownText + '</span></a></li>' : '';
      shareHtml += '</ul></div>';
